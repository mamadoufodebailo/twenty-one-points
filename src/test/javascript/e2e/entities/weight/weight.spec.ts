...
describe('Weight e2e test', () => {
  ...
  it('should create and save Weights', async () => {
    ...
    await weightComponentsPage.clickOnCreateButton();
    await promise.all([
      weightUpdatePage.setDateInput('01/01/2001' + protractor.Key.TAB + '02:30AM'),
      weightUpdatePage.setWeightInput('5'),
      weightUpdatePage.userSelectLastOption()
    ]);
    expect(await weightUpdatePage.getDateInput()).to.contain('2001-01-01T02:30', 'Expected date value to be equals to 2000-12-31');
